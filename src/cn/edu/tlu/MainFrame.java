...
class MainFrame extends JFrame implements ActionListener, ItemListener {
	...
	JLabel lible;
	MainPanel mainPanel;
	JButton btnReNew, btnLast, btnNext, btnChoose, btnFirst, btNover, btnMusic, btnBack,btnHaha;
	...
	private void init() {
		...
		btnHaha = new JButton("哈哈");
		btnHaha.setBounds(620, 150, 80, 30);
		btnHaha.setFont(font);
		super.add(btnHaha);
	...
	private void addEventHandler() {
		...
		btnHaha.addActionListener(this);
	...
	public void actionPerformed(ActionEvent e) {
		...
		} else if(e.getSource() == btnHaha){
			JOptionPane.showMessageDialog(this, "哈哈哈哈哈", "哎呀", JOptionPane.YES_OPTION);
		}
